		...
		<form id="truckPageModForm" method="post"
			...
			<div style="text-align: center; width: 850px">
				...
				<input name="xloc" id="xloc" type="text"
					value="<%=truck.getTruck_Loc_X()%>" hidden> <input name="yloc"
					id="yloc" type="text" value="<%=truck.getTruck_Loc_Y()%>" hidden>
				<%
					} else {
				%>
				<input name="xloc" id="xloc" type="text" value="0" hidden> <input
					name="yloc" id="yloc" type="text" value="0" hidden>
				<%
					}
				%>
