...
/**
 * Servlet implementation class SearchBusinessList_for_Admin
 */
@WebServlet("/searchblist")
public class SearchBusinessList_for_Admin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchBusinessList_for_Admin() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = 0;
		listCount = mservice.getBus_SearchCount(seType,seValue);
		...
		ArrayList<Business> blist = mservice.searchBusList(new ApprovalSearch(limit, currentPage, seType, seValue));
